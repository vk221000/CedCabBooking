    ...
    $.ajax({
        ...
        success: function(msg){
            ...
            var html='<div class="row">\
                ...
                <div class="tiles-admin text-center"><p>Serviceable Locations</p><p>'+servicablelocation+'</p><p id="card-servicable-locations"></p><a href="javascript:void(0)" class="btn btn-outline-info" id="managelocation">Servicable Locations</a></div></div>';
