...
function rideRequests(sort){
    ...
    $.ajax({
        ...
        success: function(data){
            var html="<table id='customers'><tr><th>From</th><th>To</th><th>Cab Type</th><th>RideDate(YYYY-MM-DD)<a href='javascript:void(0)' id='rides-req-sort-asc-admin'>&#8657;</a><a href='javascript:void(0)' id='rides-req-sort-desc-admin'>&#8659;</a></th><th>TotalDistance(KM)</th><th>Luggage(KG)</th><th>TotalFare (₹)</th><th>Action</th></tr>";
            if (data!=false) {
...
function completedRidesFilter(){
    var html="<div id='select-fields'><select name='cars' id='comp-cars'>\
                <option>All</option>\
...
function allRidesFilter(){
    var html="<div id='select-fields'><select name='cars' id='cars'>\
                <option>All</option>\
                <option value='CedMicro'>CedMicro</option>\
                <option value='CedMini'>CedMini</option>\
                <option value='CedRoyal'>CedRoyal</option>\
...
function canceledRidesAll(sort){
    $.ajax({
        ...
        dataType: 'json',
        success: function(data){
            var html="<table id='customers'><tr><th>From</th><th>To</th><th>Cab Type</th><th>RideDate(YYYY-MM-DD)<a href='javascript:void(0)' id='rides-canc-sort-asc-admin'>&#8657;</a><a href='javascript:void(0)' id='rides-canc-sort-desc-admin'>&#8659;</a></th><th>TotalDistance(KM)</th><th>Luggage(KG)</th><th>TotalFare (₹)</th></tr>";
            if (data!=false) {
                for (var i=0;i<data.length;i++) {
                    html+="<tr><td>"+data[i]['from']+"</td><td>"+data[i]['to']+"</td><td>"+data[i]['cab_type']+"</td><td>"+data[i]['ride_date']+"</td><td>"+data[i]['total_distance']+"</td><td>"+data[i]['luggage']+"</td><td>"+data[i]['total_fare']+"</td></tr>";
                }
...
function userRequest(sort){
    $.ajax({
        ...
        dataType:'json',
        success: function(data){
            var html="<table id='customers'><tr><th>UserName</th><th>Name</th><th>DateofSignup(YYYY-MM-DD)<a href='javascript:void(0)' id='user-req-sort-asc'>&#8657;</a><a href='javascript:void(0)' id='user-req-sort-desc'>&#8659;</a></th><th>Mobile</th><th>Action</th></tr>";
            if (data!="false") {
                for (var i=0;i<data.length;i++) {
...
function approvedUserRequests(sort){
    $.ajax({
        ...
        dataType:'json',
        success: function(data){
            var html="<table id='customers'><tr><th>UserName</th><th>Name</th><th>DateofSignup(YYYY-MM-DD)<a href='javascript:void(0)' id='user-approved-req-sort-asc'>&#8657;</a><a href='javascript:void(0)' id='user-approved-req-sort-desc'>&#8659;</a></th><th>Mobile</th></tr>";
            if (data!=false) {
                for (var i=0;i<data.length;i++) {
